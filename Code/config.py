...
def get_args():
    ...
    parser.add_argument('--data_root', default='./dataset', help='root for all dataset')
    parser.add_argument('--dset', default='ImageNet-C', type=str, help='ImageNet-C')
    ...
    # Exp Settings
    parser.add_argument('--method', default='POEM', type=str, help='no_adapt, tent,tentPOEM, eata, sar, deyo,POEM')

    parser.add_argument('--model', default='vitbase_timm', type=str, help='resnet50_bn_torch_branch or resnet50_gn_timm or resnet50_gn_timm_branch or resnet50_bn_torch or vitbase_timm or vitbase_timm_branch')
    parser.add_argument('--exp_type', default='mix_shifts', type=str, help='normal, mix_shifts, bs1, label_shifts, spurious')
